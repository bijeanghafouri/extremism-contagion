...
models <- list(
  "biden2020"     = lm(adopted ~ total_exposures + theta, biden2020),
  "acab"     = lm(adopted ~ total_exposures + theta, acab),
  "blacklivesmatter"     = lm(adopted ~ total_exposures + theta, blacklivesmatter),
  "blm"     = lm(adopted ~ total_exposures + theta, blm),
  "boycottgoya" = lm(adopted ~ total_exposures + theta, boycottgoya),
  "tre45on" = lm(adopted ~ total_exposures + theta, tre45on),
  "abolishthepolice" = lm(adopted ~ total_exposures + theta, abolishthepolice),
  "defundthepolice" = lm(adopted ~ total_exposures + theta, defundthepolice),
  "trumpvirus" = lm(adopted ~ total_exposures + theta, trumpvirus),
  "whitesupremacy" = lm(adopted ~ total_exposures + theta, whitesupremacy)
  )
...
models <- list(
  ...
  "obamagate"     = lm(adopted ~ total_exposures + theta, obamagate),
  "qanon"     = lm(adopted ~ total_exposures + theta, qanon),
  "stopthesteal"     = lm(adopted ~ total_exposures + theta, stopthesteal),
  "whitelivesmatter" = lm(adopted ~ total_exposures + theta, whitelivesmatter),
  "wwg1wga" = lm(adopted ~ total_exposures + theta, wwg1wga)
  )
